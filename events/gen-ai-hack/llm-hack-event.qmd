...
[**It's judging and grand finals day!**](judging.qmd)
...
## Rooms and Sessions
Our problem statement and tooling sessions will take place in the rooms below. The [floorplan is available here.](floorplan.png)

The armoury sessions should be 30 minutes each, so make sure you get to the ones you'd like to!

| **Room**          | **ELG01**                              | **ELG02**                                         | **ELG03**                      | **ELG05**                                      | **ELG08**                           | **ELG15**                                             | **EM01** |
|-------------------|----------------------------------------|---------------------------------------------------|--------------------------------|------------------------------------------------|-------------------------------------|-------------------------------------------------------|----------|
| Problem Statements          | 1                                      | 2                                                 | 3                              | 4                                              | 5                                   | 6                                                     | 7        |
|                   |                                        |                                                   |                                |                                                |                                     |                                                       |          |
| Tools and Tricks  | Anthropic                              | OpenAI                                            | Microsoft                      | Coefficient                                    | Google                              | ONS                                                   |          |
|  | Claude, the API and document retrieval | Best use of ChatGPT, and the function calling API | The PowerTools suite and GenAI | Building an open-source chatbot with Langchain | Making best use of the Google suite | Building StatChat and using chat in the public sector |          |